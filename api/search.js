...
module.exports = async (req, res) => {
  ...
  if (!query) return res.status(400).json({ status: false, creator: 'Tangsky', message: 'Parameter query diperlukan' });
  ...
  try {
    ...
    return res.status(500).json({ status: false, creator: 'Tangsky', message: err.message });
  }
};