...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const result = { status: true, input: { id: artistId }, result: { artistId, name, thumbnails, topSongs, topAlbums, topSingles, topVideos, featuredOn, similarArtists, creator: 'Tangsky' } };
